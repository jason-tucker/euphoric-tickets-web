...
export const businesses = pgTable(
  ...
  // Guild → businesses is the hottest lookup in the system: the web resolves
  // it on every login/permission check (inArray over the session's guilds) and
  // the bot on nearly every interaction (getBusinessByGuildId). Not unique —
  // a guild can host multiple businesses.
